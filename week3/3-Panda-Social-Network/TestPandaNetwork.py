...
class TestPanda (unittest.TestCase):
    ...
    def test_load_panda(self):
        Panda5 = Panda("Ivan", "marcheto_qka_panda@abv.bg", "male")
        Panda1 = Panda("Maria", "marcheto_qka_panda@abv.bg", "female")
        sc = PandaSocialNetwork.load()
        self.assertTrue(sc.are_friends(Panda5, Panda1))
        self.assertTrue("Ivan" in str(sc.network))
    ...
    def test_panda_social_network_add(self):
        ...
        self.assertTrue(Panda1 in self.sc.network)
